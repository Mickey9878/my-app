...
const SideFooter = () => {
    return (
        <>
            <Center pb='80px'>
                <Grid bg="rgba(255,255,255,0.1)" width="80%" borderRadius='20' alignItems='center' opacity='0.8' height='150px' border='1px'>
                    ...
                    <GridItem textAlign="left" pl='20px' fontSize='15px'>
                        <Link><Icon as={IoDocumentText} verticalAlign='-20%' mr='10px' fontSize='20px' />Docs</Link>
                    </GridItem>
                    <GridItem textAlign="left" pl='20px' fontSize='15px'>
